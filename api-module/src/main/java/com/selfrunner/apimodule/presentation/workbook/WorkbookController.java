package com.selfrunner.apimodule.presentation.workbook;
...
import com.selfrunner.apimodule.application.workbook.WorkbookService;
...
public class WorkbookController {
    ...
    @GetMapping("")
    public ApplicationResponse<Slice<WorkbookCardRes>> getWorkbookList(@Auth Member member, @RequestParam(name = "detail") String subjectDetail, @RequestParam(name = "type") String type, @RequestParam(name = "cursor", required = false) Long cursor, @PageableDefault(sort = "created_at DESC")Pageable pageable) {
